...
public class BlankFragment15 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_blank15, container, false);
    }
    @Override
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        butt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Glide.with(BlankFragment15.this).asGif().load(R.drawable.animal_tiger).into(imageView);
                text.setText("TIGER");
                playAudio(R.raw.tiger);
            }
        });
    }
