...
public class BlankFragment23 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_blank23, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        butt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Glide.with(BlankFragment23.this).asGif().load(R.drawable.animal_kangaroo).into(imageView);
                text.setText("ካንጋሮ");
                playAudio(R.raw.kangaro);
            }
        });
    }
