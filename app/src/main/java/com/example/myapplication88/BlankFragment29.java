...
public class BlankFragment29 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_blank29, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        butt3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Glide.with(BlankFragment29.this).asGif().load(R.drawable.animal_snake).into(imageView);
                text.setText("እባብ");
                playAudio(R.raw.ebab);
            }
        });
    }
