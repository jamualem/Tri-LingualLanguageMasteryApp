...
public class BlankFragment21 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_blank21, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        butt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Glide.with(BlankFragment21.this).asGif().load(R.drawable.animal_frog).into(imageView);
                text.setText("እንቁራሪት");
                playAudio(R.raw.enkurarit);
            }
        });
    }
