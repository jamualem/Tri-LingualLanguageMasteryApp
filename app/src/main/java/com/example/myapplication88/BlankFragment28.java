...
public class BlankFragment28 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_blank28, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        butt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Glide.with(BlankFragment28.this).asGif().load(R.drawable.animal_rabbit).into(imageView);
                text.setText("ጥንቸል");
                playAudio(R.raw.tinchel);
