...
public class BlankFragment16 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_blank16, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        butt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Glide.with(BlankFragment16.this).asGif().load(R.drawable.animal_ant).into(imageView);
                text.setText("ጉንዳን");
                playAudio(R.raw.gundan);
