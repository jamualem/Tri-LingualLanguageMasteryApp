...
public class BlankFragment20 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_blank20, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        butt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Glide.with(BlankFragment20.this).asGif().load(R.drawable.animal_elephant).into(imageView);
                text.setText("ዝሆን");
                playAudio(R.raw.zehon);
            }
        });
    }
