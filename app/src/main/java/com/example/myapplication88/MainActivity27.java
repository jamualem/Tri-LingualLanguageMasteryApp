    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.button11:
                ...
                text.setText("kudha tokko");
                text.setTextColor(Color.GREEN);
                break;
            case R.id.button12:
                playAudio(soundIds[11]);
                text.setText("kudha lama");
                text.setTextColor(Color.RED);
                break;
            case R.id.button13:
                playAudio(soundIds[12]);
                text.setText("kudha sadii");
                text.setTextColor(Color.YELLOW);
                break;
            case R.id.button14:
                playAudio(soundIds[13]);
                text.setText("kudha afur");
                text.setTextColor(Color.BLUE);
                break;
            case R.id.button15:
                playAudio(soundIds[14]);
                text.setText("kudha shan");
                text.setTextColor(Color.CYAN);
                break;
            case R.id.button16:
                playAudio(soundIds[15]);
                text.setText("kudha jaha");
                text.setTextColor(Color.GREEN);
                break;
            case R.id.button17:
                playAudio(soundIds[16]);
                text.setText("kudha torba");
                text.setTextColor(Color.RED);
                break;
            case R.id.button18:
                playAudio(soundIds[17]);
                text.setText("kudha saddeet");
                text.setTextColor(Color.YELLOW);
                break;
            case R.id.button19:
                playAudio(soundIds[18]);
                text.setText("kudha sagal");
                text.setTextColor(Color.BLUE);
                break;
            case R.id.button20:
                playAudio(soundIds[19]);
                text.setText("diigdama");
                text.setTextColor(Color.CYAN);
                break;
