...
public class BlankFragment18 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_blank18, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        butt4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Glide.with(BlankFragment18.this).asGif().load(R.drawable.animal_cat).into(imageView);
                text.setText("ድመት");
                playAudio(R.raw.dmat);
            }
        });
    }
