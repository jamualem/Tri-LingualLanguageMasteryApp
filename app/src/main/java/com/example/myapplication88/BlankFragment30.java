...
public class BlankFragment30 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_blank30, container, false);
    }
    @Override
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        butt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Glide.with(BlankFragment30.this).asGif().load(R.drawable.animal_tiger).into(imageView);
                text.setText("ነብር");
                playAudio(R.raw.nebir);
            }
        });
    }
