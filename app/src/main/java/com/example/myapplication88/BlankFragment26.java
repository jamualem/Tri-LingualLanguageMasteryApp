...
public class BlankFragment26 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_blank26, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        butt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Glide.with(BlankFragment26.this).asGif().load(R.drawable.animal_monkey).into(imageView);
                text.setText("ዝንጀሮ");
                playAudio(R.raw.zengero);
            }
        });
    }
