...
public class BlankFragment27 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_blank27, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        butt4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Glide.with(BlankFragment27.this).asGif().load(R.drawable.animal_pig).into(imageView);
                text.setText("አሳማ");
                playAudio(R.raw.asama);
            }
        });
    }
