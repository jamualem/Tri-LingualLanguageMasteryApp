...
public class BlankFragment22 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_blank22, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        butt3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Glide.with(BlankFragment22.this).asGif().load(R.drawable.animal_goat).into(imageView);
                text.setText("በግ");
                playAudio(R.raw.begg);
            }
