...
public class BlankFragment19 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        butt3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Glide.with(BlankFragment19.this).asGif().load(R.drawable.animal_dog).into(imageView);
                text.setText("ውሻ");
                playAudio(R.raw.wesha);
            }
        });
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_blank19, container, false);
    }
